...
<div id="app" class="d-flex justify-content-center align-items-center" style="">
  <div style="padding: 20px" class="d-flex">
    <form action="/cds" enctype="multipart/form-data" method="POST">
      @csrf
      <div class="">
        <div>
          <h1>Add new CD</h1>
        ...
        <div class="form-group row">
          ...
          <input id="release_year" type="number" class="form-control @error('release_year') is-invalid @enderror" name="release_year" value="{{ old('release_year') }}" autocomplete="release_year">
        ...
        <div class="row mt-4" style="width: 100%">
          <button class="btn btn-primary" style="width: 100%">Add new CD</button>
        </div>
      </div>
    </form>
  </div>
