...
<div id="app" class="d-flex justify-content-center align-items-center" style="">
  <div style="padding: 20px" class="d-flex">
    <form action="/genres" enctype="multipart/form-data" method="POST">
      @csrf
      <div class="">
        <div>
          <h1>Create Genre</h1>
        ...
        <div class="form-group row">
          ...
          <input id="genre_name" type="text" class="form-control @error('genre_name') is-invalid @enderror" name="genre_name" value="{{ old('genre_name') }}" autocomplete="genre_name">
